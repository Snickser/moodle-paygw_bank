...
Этот плагин представляет собой платежный шлюз Moodle, который обеспечивает поддержку платежей, осуществляемых посредством денежных переводов или других методов ручной оплаты, которые должны быть одобрены человеком.
...
- Автоматическое утверждение заявок в которых имеются загруженные файлы.
- Возможность студенту заменять файлы после загрузки в заявку.
