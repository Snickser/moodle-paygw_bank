...
$string['send_new_request_mail'] = 'Send message about each new request';
$string['send_new_attachments_mail'] = 'Send message about new file in request';
$string['send_confirm_mail_to_support'] = 'Send message when a payment is approved';
