...
$string['allowed_file_types_help'] = 'A comma separated list of file extensions allowed to upload, like ".zip". If empty, all files document and web_image types are allowed.';
