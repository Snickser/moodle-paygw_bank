...
$string['email_to_notify_desc'] = 'All other message sending parameters have been moved to the gateway configuration.';
...
$string['send_new_request_mail'] = 'Send an email about each new request (the address can be specified in the plugin settings)';
$string['send_new_attachments_mail'] = 'Send an email about new file in request';
$string['send_confirm_mail_to_support'] = 'Send an email when a request is approved';
...
$string['fixdesc'] = 'Description';
$string['fixdesc_help'] = 'This setting sets a fixed comment for this payment.';
$string['unfixcost'] = 'Unfixed price mode';
$string['unfixcost_help'] = 'Enable the ability for students to pay with an arbitrary amount.';
$string['autocommit'] = 'Automatically approve/deny request after file(s) are uploaded';
