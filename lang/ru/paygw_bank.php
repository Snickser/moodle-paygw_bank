...
$string['send_teacher_mail'] = 'Также отправлять эти сообщения преподавателям курса';
$string['send_teacher_mail_help'] = 'Вы также можете включить групповые ограничения для учителей в настройках платежного интерфейса.';
...
{$a->url}';
$string['send_new_request_mail'] = 'Отправлять письмо о создани нового запроса (адрес указывается в настройках плагина)';
$string['send_new_attachments_mail'] = 'Отправлять письмо о добавлении новых файлов в запрос';
$string['send_confirm_mail_to_support'] = 'Отправлять письмо об одобрении запроса';
...
$string['unfixcost'] = 'Произвольная цена';
$string['unfixcost_help'] = 'Предоставить студентам возможность платить произвольную сумму.';
